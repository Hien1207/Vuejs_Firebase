  ...
  <div class="media">
    ...
    <div class="choose-media">
      <div>
        <img
          style="width: 10%"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIdc8e6h0LzkO3XDIp1Q4f-ltJ4IPJNr7FjSCnxikayoxiTYXHVtVR4Ton1eUC1FQ4Jcg&usqp=CAU"
        />
      </div>
    ...
    <div class="show">
      <div class="media_is" v-for="media in medias" :key="media">
        <div class="image_medi">
          <img
            class="wid"
            @click="$emit('fetchImgSrc', $event.target.src)"
            :src="media.img1"
            alt=""
          />
        </div>
